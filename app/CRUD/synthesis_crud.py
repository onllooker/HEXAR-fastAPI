...
from app.schemas.synthesis_schema import RecipeCreateSchema, SynthesisCreateSchema, RecipeReadSchema, SynthesisReadSchema
from app.database.db_models import Substances_SynthesesORM, SynthesesORM, SubstancesORM
...
async def get_syntheses(session:AsyncSession)->SynthesisReadSchema:
    try:
...
async def delete_substance_from_synthesis(session:AsyncSession, synthesis_id:int):
    pass
